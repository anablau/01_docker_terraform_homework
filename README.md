...
Command used to check: ```bash docker run -it --rm --entrypoint bash python:3.13 -c " python --version pip --version "
...
If the database service is named db and uses the default Postgres port 5432, pgAdmin should connect using:
Plaintext
